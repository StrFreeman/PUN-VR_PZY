...
public class TestPlatform : MonoBehaviour {
    ...
    private ForceSeatState stateBeforeShock;
    ...
    public float testShockStep = 1f;

    public float testRotationStep = 0.5f;
    public float testTranslateStep = 0.5f;
    ...
    private void StartShock(Attribute attribute, bool isPositive, float step, float dur)
    {
